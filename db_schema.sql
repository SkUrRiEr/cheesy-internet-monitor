...
--
-- Host: 127.0.0.1    Database: julian_internet_monitor
-- ------------------------------------------------------
...
CREATE TABLE `conlog` (
  ...
  `dns_down` datetime DEFAULT NULL,
  `dns_up` datetime DEFAULT NULL,
  `conn_down` datetime DEFAULT NULL,
...
-- Dump completed on 2016-03-31 14:36:35
